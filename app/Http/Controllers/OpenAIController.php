 ...
 * @param string|null $quizDomain The domain for the quiz questions.
 * @return array
 */
public function sendRequest($numQuizzes = 1, $quizDomain = null)
{
