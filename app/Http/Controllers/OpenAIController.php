...
class OpenAIController extends Controller
{
    ...
    public function sendRequest()
    {
        ...
        $requestData = [
            ...
            'prompt' => 'I want you to create a quiz consisting of 1 question related to anything I tell you. The quiz should have this structure: [Question x][4 answers, numbered a,b,c,d][The letter of the correct answer] The answers should be as factual and accurate as possible, without ambiguity or falsehoods. Only return the quiz in this format, to be directly compatible with uncompressed Json Format, WITH NO MORE CHARACTERS : [ { \"question\": \"\", \"options\": [\"\"], \"correct\": \"\" } ]. The subject is math. Do not return anything else, just the json.\n\n',
            'temperature' => 0.7,
            'max_tokens' => 656,
            'top_p' => 1,
            'frequency_penalty' => 0,
