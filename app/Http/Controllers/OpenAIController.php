...
class OpenAIController extends Controller
{
    ...
    public function sendRequest()
    {
        ...
        $requestData = [
            ...
            I want you to create a quiz consisting of 1 question related to anything I tell you. The quiz should have this structure:
            [Question x]
            [4 answers, numbered a,b,c,d]
            [The letter of the correct answer]

            The answers should be as factual and accurate as possible, without ambiguity or falsehoods.

            Only return the quiz in this format, to be directly compatible with Json Format:
